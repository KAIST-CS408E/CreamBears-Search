...
"""<div class="card"><div class="card-body"><a href="https://portal.kaist.ac.kr/ennotice/\B/\I" id="artREPLACEREPLACE" target="_blank" onclick="read(event)">\T</a><p>\t10</p><p>\c100</p></div></div>"""
  )
}
